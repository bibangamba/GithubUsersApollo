...
import com.levelup.bibangamba.githubusersGraphQL.adapters.GithubUsersAdapter;
...
public class MainActivity extends AppCompatActivity implements GithubUsersView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        githubUserGraphQLPresenter = new GithubUserGraphQLPresenter(this, this, new GithubService());
